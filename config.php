...
if(! $db->tableExists('users'))
{
    ...
    createTable("store_brand" , $store_brand_table);
    createTable("brands" , $brands_table);
    createTable("copons_table" , $copons_table);
	createTable("user_copon" , $users_copon_table);
